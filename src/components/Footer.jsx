    ...
    <footer className="relative bg-black text-white py-12 md:py-16 px-6 md:px-16 min-h-screen flex flex-col justify-between overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-full justify-between">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-8 gap-10">
          <div className="flex flex-col gap-6 w-full md:w-auto">
            <div>
              ...
              <a href="mailto:abdulrashidqureshi9376@gmail.com" className="text-xl md:text-5xl font-medium hover:text-[#ccff00] transition-colors break-words">
                abdulrashidqureshi9376@gmail.com
              </a>
            </div>
          ...
          <div className="flex flex-col items-start md:items-end text-left md:text-right w-full md:w-auto mt-4 md:mt-0">
            ...
            <p className="text-gray-400 text-sm mb-6 max-w-xs">
              Open to learning opportunities, data analysis projects and AI automation work.
            </p>
        ...
        <div className="flex flex-wrap justify-between items-center py-6 border-t border-white/10 mb-4 text-sm md:text-lg font-medium">
          <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="hover:text-[#ccff00] transition-colors">Instagram</a>
          <a href="https://www.linkedin.com/signup/public-profile-join?vieweeVanityName=abdul-rashid-qureshi-a50727435&trk=public_profile-settings_top-card-primary-button-join-to-view-profile" target="_blank" rel="noopener noreferrer" className="hover:text-[#ccff00] transition-colors">LinkedIn</a>
          <a href="https://github.com/abdulrashidqureshi9376" target="_blank" rel="noopener noreferrer" className="hover:text-[#ccff00] transition-colors">GitHub</a>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-xs text-gray-400 mt-auto pt-6">
          <p>© {new Date().getFullYear()} Abdul Rashid Qureshi. All Rights Reserved.</p>
