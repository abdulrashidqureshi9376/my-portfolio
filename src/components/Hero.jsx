...
const Hero = ({ onPreloadComplete }) => {
  const [text, setText] = useState('ABDUL RASHID');
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span className="font-bold">BCA Student</span> <span className="font-light italic text-gray-300">/ Data Analyst</span>
        </p>
