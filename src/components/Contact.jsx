...
const ContactSection = () => {
    ...
    const sendEmail = (e) => {
        ...
        const whatsappNumber = '919376881839';
        const whatsappMessage = `Hello Abdul Rashid,
...
${message}`;
        ...
        setStatusMessage({ text: 'WhatsApp opened with your message.', type: 'success' });
    };
                ...
                <div ref={infoRef} className="w-full lg:w-5/12 flex flex-col justify-start">
                    ...
                    <div className="flex flex-col gap-8 md:gap-10">
                        ...
                        <div className="block">
                            ...
                            <a href="mailto:abdulrashidqureshi9376@gmail.com" className="text-lg md:text-xl tracking-wide hover:text-[#ccff00] transition-colors break-all">abdulrashidqureshi9376@gmail.com</a>
                        </div>

                        {/* Phone / Role */}
                        <div className="block">
                            <p className="text-gray-400 text-sm mb-2">Role:</p>
                            <p className="text-lg md:text-xl tracking-wide">BCA Student / Data Analyst</p>
                        </div>

                        <div className="block">
                            <p className="text-gray-400 text-sm mb-2">Phone:</p>
                            <a href="tel:+919376881839" className="text-lg md:text-xl tracking-wide hover:text-[#ccff00] transition-colors">+91 93768 81839</a>
                        </div>
                        ...
                        <div className="mt-2 md:mt-4 flex flex-col items-start">
                            ...
                            <div className="flex items-center justify-start gap-3">
                                <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                                ...
                                <a href="https://www.linkedin.com/jobs/?skipRedirect=true" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                ...
                                <a href="https://github.com/abdulrashidqureshi" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
